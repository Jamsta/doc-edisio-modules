= Edisio EMS-200 "Capteur de mouvement"
...
Placé dans un couloir, le salon, le gararge de votre maison par exemple, le capteur de mouvement détecte une présence, le changement d'état est instantané.

Grâce à son angle de vision étendu et sa portée, il permet de sécuriser un large périmètre. L'indicateur Led intégré signal tous changement d'état. 
